...
class MdnaChildLabTblController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('MdnaChildLabTbl');
    ...
    public function actionAdmin() {
        $model = new MdnaChildLabTbl('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['MdnaChildLabTbl']))
            $model->attributes = $_GET['MdnaChildLabTbl'];
     ...
     * @return MdnaChildLabTbl the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = MdnaChildLabTbl::model()->findByPk($id);
        if ($model === null)
     ...
     * @param MdnaChildLabTbl $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'mdna-child-lab-tbl-form') {

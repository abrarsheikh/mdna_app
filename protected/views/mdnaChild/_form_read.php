...
<div class="wide form" >
    ...
    <div class="page-header">
        <h1><?php echo Yii::app()->params['ci']; ?></h1>
    </div>
    <div class="row-fluid">
        <div class="span6">
...
//            $dataProvider = new CActiveDataProvider('MdnaChildAnthropometryMdl', array(
//                        'criteria' => $criteria,
//                    ));
    ...
    <div class="page-header">
        <h1><?php echo Yii::app()->params['ans']; ?></h1>
    </div>
